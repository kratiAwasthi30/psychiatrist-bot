    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <main className="container mx-auto px-4 py-8">
          <Button
            variant="ghost"
            onClick={() => navigate('/psychiatrist/schedule')}
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input type="number" defaultValue={60} className="w-full mt-1 p-2 border rounded-lg" />
                </div>
                <div>
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-8">
          <div>
            <h1 className="font-serif text-4xl font-bold text-foreground mb-2">Schedule</h1>
          ...
          <div className="flex gap-3">
            ...
            <Button className="gap-2" onClick={() => navigate('/psychiatrist/schedule?new=true')}>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <div className={`w-6 h-6 rounded-full ${getTypeColor(apt.type)} flex items-center justify-center text-white`}>
